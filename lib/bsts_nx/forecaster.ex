defmodule BstsNx.Forecaster do
  ...
  defp build_forecast_result(trajectories, horizon, alpha, :summary, format) do
    aggregate_trajectories(trajectories, horizon, alpha, format)
  end

  defp build_forecast_result(trajectories, horizon, _alpha, :draws, format) do
    %{
  ...
  defp build_forecast_result(trajectories, horizon, alpha, :both, format) do
    summary = aggregate_trajectories(trajectories, horizon, alpha, format)

    summary
    |> Map.put(:draws, format_draws(trajectories, horizon, format))
    |> Map.put(:num_draws, length(trajectories))
  end
