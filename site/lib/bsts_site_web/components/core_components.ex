defmodule BstsSiteWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(BstsSiteWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(BstsSiteWeb.Gettext, "errors", msg, opts)
    # end
